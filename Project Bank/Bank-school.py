            ...
            while True:
               ...
               #Works Like If Else Statements
                if Choice ==  "1": #Check Balance
                    Balance()
                elif Choice == "2": #Deposit Amount
                    Deposit()
                elif Choice == "3": #Withdraw Amount
                    WithDraw()
                elif Choice ==  "4": #Send Money Others
                    send_oth()
                elif Choice == "5": #Transaction History 
                    tran_hist()
                elif Choice == "6": #Create Account
                    Account()
                elif Choice == "7": #Loan From Bank
                    loan_bank()
                elif Choice == "8": #Close Account
                    Close()
                    login()
                elif Choice == "9": #Change PassCode
                    ...
                    if change == 'Yes':
                        ...
                        print()
                elif Choice == "10": #Contact Developer
                    contact_dev()
                elif Choice == "11": #Exit Loop
                    login()
                    break
                elif Choice == "12": #Repay Loan
                    if loanavail[user] != 10E5:
                        repay_loan()
                    else:
                        invid()
                elif Choice == "13": #Loan Portfolio
                    if loanavail[user] != 10E5:
                        loan_port()
                    else:
                        invid()       
...
**The Highly Useful Feature Is:
        ...
        Also, When We Stop The Bank Forcefully, The Accounts Data Will Be Again Stored In The Txt File, Overriding The Previous File.
