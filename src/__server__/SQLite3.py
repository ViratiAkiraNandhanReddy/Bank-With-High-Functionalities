...
connection = sqlite3.connect(fr'{ os.environ.get('LOCALAPPDATA') }\Bank-With-High-Functionalities\database\sqlite3\database.sqlite3')
...
class SERVER:
    ...
    class authentication:
        ...
        def authenticate_password(self, username: str, password: str) -> bool:
            ...
            return self.cursor.fetchone()[0] == Encryption(password, shift = 8, alterNumbers = True).encrypt()
