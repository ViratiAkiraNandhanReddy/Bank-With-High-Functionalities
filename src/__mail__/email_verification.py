...
class email_verification:
    ...
    def __init__(self, receiver_mail_address: str) -> None:
        ...
        with open(fr'{DIR_PATH}\src\__mail__\templates\email_verification.html') as file:
        ...
        self.email['Subject'] = f'{self.otp} is your code to verify email at Bank With High Functionalities.'
